...
export default function NewRecipe() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (!respsonse.success) {
                throw new Error(respsonse.message);
            }
    ...
    return (
        <div className="w-fit my-20 mx-auto">
            <Link
                to={".."}
                className="w-fit py-1 px-3 mb-4 flex gap-2 items-center rounded-full bg-white hover:underline"
            >
                <MdOutlineKeyboardArrowLeft />
                Go back
            </Link>
            <div className="w-4xl grid grid-cols-[1fr_2fr]">
                {/* LEFT column */}
                <section>
